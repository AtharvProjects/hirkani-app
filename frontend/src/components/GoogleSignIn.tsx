...
export function GoogleSignIn({ onDone, setErrorMsg }: { onDone: () => void, setErrorMsg: (msg: string) => void }) {
  ...
  useEffect(() => {
    ...
    // Usually initialized in capacitor.config.ts or via Initialize method
      ...
      return (
          <div className="mt-4 w-full flex justify-center">
              <button
                  ...
                  className="flex items-center justify-center w-full px-4 py-2 border border-gray-300 rounded-full shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8C143F]"
              >
